...
export function Subscribe(){
    ...
    const [email,setEmail] = useState('');//Espelho de informações
    ...
    < div className="min-h-screen bg-blur bg-cover bg-no-repeat flex-col items-center">
        <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto"> 
            ...
            <Logo/>
                ...
                <p className="mt-4 text-gray-200 leading-tight"> Em apenas uma semana você vai dominar na prática uma das tecnologias mais utilizadas e com alta demanda para acessar as melhores oportunidades do mercado. </p>
            ...
            <div className="p-8 bg-gray-700 border-gray-500 rounded">
                ...
                type="submit" 
                disabled={loading}
                className="mt-4 bg-green-500 uppercase py-4 runded font-bold text-sm hover:bg-green-700 transition-colors disabeld:opacity-50">
                    Garantir Minha Vaga
                </button>
